...
scores_arrs = {
    ...
    "0.3": [0, 1, 2, 2.5, 3, 3.5],
    "0.4": [0, 1, 3, 3.5],
    "1.1": [0, 0.25, 0.5, 0.75, 1, 1.25, 2.5, 2.75, 3, 3.25, 3.5],
    "1.2": [0, 0.5, 0.75, 1, 1.5, 2, 2.25, 2.5, 3],
    "2.1": [0, 0.5, 1.5, 2, 2.332, 2.666, 3, 3.25],
    "2.2": [0, 0.5, 1, 1.75, 2, 2.25, 2.5, 2.75, 3.25, 3.5, 3.75],
    "3.1": [0, 0.5, 1, 1.25, 1.5, 2, 2.5, 2.75, 3, 3.5],
    "3.2": [0, 0.25, 0.5, 0.75, 1, 1.25, 2.25, 3.25, 3.5],
    "4.1": [0, 0.25, 0.75, 1, 1.332, 1.666, 2.5, 2.75, 3, 3.25, 3.75],
    "4.2": [0, 0.25, 0.5, 1.5, 1.75, 2, 2.25, 2.5, 2.75, 3, 3.25, 3.75],
    "5.1": [0, 0.25, 0.5, 0.75, 1, 1.332, 1.666, 2.5, 3.25, 3.5],
    "5.2": [0, 0.25, 0.75, 1.25, 1.5, 1.75, 2, 2.75, 3, 3.25, 3.75]
}
...
def compareAudio(file_path,arr):
    ...
    F, P, R = mir_eval.onset.f_measure(np.array(arr),onset_times , window=0.05)
    score = (P/R)*10
    return score
